...
#ifndef PICTURES_VIEW_SWIFT_H
#define PICTURES_VIEW_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="pictures_view",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13pictures_view11AppDelegate")
...
SWIFT_CLASS("_TtC13pictures_view17MainFlutterWindow")
