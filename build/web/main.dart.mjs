...
_1589: () => globalThis.removeSplashFromWeb(),
...
_1643: x0 => new WeakRef(x0),
_1644: x0 => x0.deref(),
_1650: Date.now,
_1652: s => new Date(s * 1000).getTimezoneOffset() * 60 ,
_1653: s => {
...
_1655: () => typeof dartUseDateNowForTicks !== "undefined",
_1656: () => 1000 * performance.now(),
_1657: () => Date.now(),
_1658: () => {
...
_1660: () => new WeakMap(),
_1661: (map, o) => map.get(o),
_1662: (map, o, v) => map.set(o, v),
_1663: () => globalThis.WeakRef,
_1674: s => JSON.stringify(s),
_1675: s => printToConsole(s),
_1676: a => a.join(''),
_1679: (s, t) => s.split(t),
_1680: s => s.toLowerCase(),
_1681: s => s.toUpperCase(),
_1682: s => s.trim(),
_1683: s => s.trimLeft(),
_1684: s => s.trimRight(),
_1686: (s, p, i) => s.indexOf(p, i),
_1687: (s, p, i) => s.lastIndexOf(p, i),
_1689: Object.is,
_1690: s => s.toUpperCase(),
_1691: s => s.toLowerCase(),
_1692: (a, i) => a.push(i),
_1696: a => a.pop(),
...
_1705: (a, i) => a[i],
_1706: (a, i, v) => a[i] = v,
_1708: (o, offsetInBytes, lengthInBytes) => {
...
_1711: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
_1712: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
...
_1715: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
_1717: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
_1718: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
...
_1766: o => Object.keys(o),
_1767: (ms, c) =>
              setTimeout(() => dartInstance.exports.$invokeCallback(c),ms),
_1768: (handle) => clearTimeout(handle),
_1769: (ms, c) =>
          setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
_1770: (handle) => clearInterval(handle),
_1771: (c) =>
              queueMicrotask(() => dartInstance.exports.$invokeCallback(c)),
_1772: () => Date.now(),
_1774: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
_1777: (x0,x1) => x0.send(x1),
...
_1784: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
_1785: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
_1803: () => new XMLHttpRequest(),
_1804: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
_1806: x0 => x0.getAllResponseHeaders(),
_1808: (s, m) => {
          try {
...
_1872: (o, p) => o[p],
_1873: (o, p, v) => o[p] = v,
_1874: (o, m, a) => o[m].apply(o, a),
_1876: o => String(o),
_1877: (p, s, f) => p.then(s, f),
_1878: s => {
      if (/[[\]{}()*+?.\\^$|]/.test(s)) {
          s = s.replace(/[[\]{}()*+?.\\^$|]/g, '\\$&');
      }
...
_1932: (x0,x1) => x0.withCredentials = x1,
...
_14768: x0 => x0.status,
_14769: (x0,x1) => x0.responseType = x1,
_14771: x0 => x0.response,
_14775: () => globalThis.window.flutterCanvasKit,
_14776: () => globalThis.window._flutter_skwasmInstance
    };
